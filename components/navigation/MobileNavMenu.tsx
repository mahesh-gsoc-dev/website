        ...
        <div className="shadow-xs divide-y-2 divide-gray-50 rounded-lg bg-white">
          <div className="space-y-6 px-4 pb-6 pt-4">
            <div className="flex items-center justify-between">
              ...
              <div
                className="justify-content -mr-2 flex flex-row items-center"
                data-testid="MobileNav-button"
              >
                <SearchButton
          ...
          <div
            className="space-y-2 px-5 py-2"
            onClick={() => showMenu('learning')}
            data-testid="MobileNav-docs"
          >
          ...
          <div
            ...
            data-testid="MobileNav-community"
          >
            <h4 className="flex justify-between font-medium text-gray-800">
              ...
              <div>
                ...
                {open === 'language' &&
                  uniqueLangs.map((lang) => (
                    ...
                    >
                      {langMap[
                        lang.text.toLowerCase() as keyof typeof langMap
                      ] || lang.text}
                    </button>
                  ))}
              </div>
          ...
          {/* Fix: Ensure "Star on GitHub" button is visible in mobile view
          Added responsive styles for mobile NavMenu and button positioning */}
          <div
            className="space-y-2 px-5 py-4 w-full flex items-center justify-center"
            data-testid="MobileNav-GitHub-Button"
          >
            <GithubButton
              text="Star on GitHub"
